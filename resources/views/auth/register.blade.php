...
<head>
    ...
    <title>Daftar - Finora Diary</title>
...
<body class="p-4 min-h-screen flex justify-center items-center">
    ...
    <div class="max-w-md w-full binder-paper rounded-3xl p-6 md:p-8 relative my-4">
        ...
        <div class="sm:pl-5">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4 font-diary">
                @csrf

                <div>
                    <label for="name" class="text-sm font-bold text-[#4E342E] block">
                        Nama
                    </label>
                ...
                <div>
                    <label for="password_confirmation" class="text-sm font-bold text-[#4E342E] block">
            ...
            <div class="mt-6 pt-4 border-t-2 border-dashed border-[#D7CCC8] text-center font-diary text-sm text-gray-600">
                Sudah punya akun diary?
                <a href="{{ route('login') }}" class="text-[#2E7D32] font-bold hover:underline">
                    Masuk di sini
                </a>
            </div>
